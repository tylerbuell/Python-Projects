...
class User:
    ...
    def assign_ticket(self):
        ...
        previous_owner = ticket.user_assigned_to
        if ticket.resolved:
...
def create_user():
    ...
    #User.user_dict["assigned_tickets"][user.assigned_tickets] = user

    User.UserDB_insert.execute({"username":user.username,"workgroup":user.workgroup,"assigned_tickets":str(user.assigned_tickets)})
    menu()
    return user
